...
\frame{\frametitle{Thoughts/hints regarding commit messages}
  ...
  Ideally:
  \bi
    \item Want to describe \emph{what} and (sometimes) \emph{why} you did something.
    ...
    \item \lst{git com "}{\blue Add slide regarding commit messages.}\lst{"}
    \item \emph{This commit will }{\blue Add slide regarding 
       commit messages.}
...
\frame{\frametitle{Thoughts/hints regarding commit messages}
  \bi
    ...
    \item Seems overkill -- but we've found short explanations in the 
      \lst{git shell} to be fine (as long as you commit often).
  \ei
}
