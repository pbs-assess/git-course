...
\date{Wednesday 21st and Thursday 22nd June at Vancouver Island
...
\frame{\frametitle{\LaTeX\ installation}
  ...
  \bi
    ...
    \item On MAC, install Mac\TeX:\\
      ...
      \lstinline{pdflatex git-course-setup.tex}
  \ei
  \bigskip
}
...
\frame{\frametitle{Text editor}
  ...
  [We use \textbf{Xemacs} for everything as it has many keyboard shortcuts
    and colours text and code based on the file extension, but it has a very
