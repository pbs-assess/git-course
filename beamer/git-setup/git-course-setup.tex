...
\frame{\frametitle{Get a \gh\ account}
  ...
  \bi
    ...
    \item Have a picture handy, and attach it to your profile. It actually
      makes it easier if you can see your collaborators.
  \ei
}
...
\frame{\frametitle{Configure the Git application}
  \bi
    \item Windows:
      \bn
        \item Create the directory \lstinline[escapechar="\\"]{C:\\github}.
...
\frame{\frametitle{Cloning the git-course repository}
  For these instructions, replace GITHUB-USER with your \gh\ account name.
  \bi
...
\frame{\frametitle{If you want to build these slides..}
  ...
  have \LaTeX\ installed. I suggest trying, \emph{beamer} is great!
  \bi
