...
\frame{\frametitle{Network Graph}
  \bi
     ...
     \item Hover the mouse over the commit to see:
     \bi
       \item who committed
       \item the commit \lst{HASH} -- a hexadecimal number that identifies
         that commit
     ...
     \item In the comments (or when you do \lst{git com "..."}) you can include
        a \lst{HASH} from any other commit.
  \ei
}
...
\frame{\frametitle{More on the Network Graph}
  The Network Graph is very useful when collaborating.....TO DO.
}
