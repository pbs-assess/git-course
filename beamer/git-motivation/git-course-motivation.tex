...
\frame{\frametitle{Can easily catch up with collaborator}
  ...
  All files that Chris edited got updated, plus I now have any new files, and our folder structures are identical. 
}

\frame{\frametitle{Easy to answer questions}
  ...
  Rather than go to my code that I haven't looked at for six months, I could click on link and answer very quickly.
}
