...
\frame{\frametitle{Exercise 2 -- help from friends}
  \be
    ...
    \item Person 1 copies \tt{git-course/exercise-files/helpFriends.txt} into their new repository (on their computer).
    \item \listinline{add}, \listinline{commit}, \listinline{push}. Check Network Graph.
    \item Persons 2, 3 and 4 then fork and clone the repository. 
    \item Everyone does some editing as per the instructions before each paragraph.
  \ei
}
