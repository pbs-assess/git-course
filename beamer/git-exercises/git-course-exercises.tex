...
\frame{\frametitle{Exercise 1 -- on your own}
  \bn
    ...
    \item \lst{git commit ``<commit description>''} frequently and \lst{git push} occasionally.
    \item Keep an eye on (and refresh) your Network Graph to understand what's going on. (There can be a short delay until it refreshes).
  \en
}
