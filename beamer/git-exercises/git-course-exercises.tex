...
\frame{\frametitle{Exercise 1 -- individuals}
  \bn
    \item Each person sets up a new repository \lstinline{simple-text}, following \emph{git-course-intro.pdf}.
    \item Add some notes to the readme file (`simple example text to learn git').
    \item Copy the text file **(**we provide up front).
